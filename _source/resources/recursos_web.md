...
layout: _post
title: Recursos web
description: Gráficos, Fuentes, ...
crtime: 2015-12-28 11:19:14
---
...
* [icon-fonts](http://pepsized.com/icon-fonts-in-use-with-a-fancy-hover-effect/).
* [IconHoverEffects](http://tympanus.net/Development/IconHoverEffects/).
* [stackicons](http://stackicons.com/).
* [stackicons-icon-fonts](https://css-tricks.com/stackicons-icon-fonts/).
* [multi-colored-icon-fonts](http://www.zenman.com/blog/how-to-create-multi-colored-icon-fonts-for-responsive-web-design/).
* [useiconic](https://useiconic.com/open/).
* [fontcustom](http://fontcustom.com/).
* [glyphter](http://glyphter.com/).
* [codepen](http://codepen.io/parkerbennett/pen/tIzho).
